 ...
 * @author Shai Almog
 */
public class FamilyChoreAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "FamilyChoreApp";
    ...
    private FamilyChoreApp mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new FamilyChoreAppStub());
    }
